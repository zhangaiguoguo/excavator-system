...
(
    20
) NOT NULL AUTO_INCREMENT COMMENT '字典主键',
    dict_name VARCHAR
(
    100
...
(
    20
) NOT NULL AUTO_INCREMENT COMMENT '字典编码',
    dict_sort INT
(
    4
) DEFAULT 0 COMMENT '字典排序',
    dict_label VARCHAR
(
    100
...
INSERT INTO sys_dict_type (dict_name, dict_type, status, create_by, remark)
VALUES ('价格单位', 'work_hours_unit', '0', 'admin', '租赁/接单计费单位');
INSERT INTO sys_dict_data (dict_sort, dict_label, dict_value, dict_type, status, create_by)
VALUES (1, '元/小时', '1', 'work_hours_unit', '0', 'admin'),
...
INSERT INTO sys_dict_type (dict_name, dict_type, status, create_by, remark)
VALUES ('机械状态', 'machine_status', '0', 'admin', '设备当前状态');
INSERT INTO sys_dict_data (dict_sort, dict_label, dict_value, dict_type, status, create_by)
VALUES (1, '下架', '0', 'machine_status', '0', 'admin'),
       (2, '空闲', '1', 'machine_status', '0', 'admin'),
       (3, '工作中', '2', 'machine_status', '0', 'admin');

-- 3.1 新旧程度 (machine_condition) PRD 4.2.1
INSERT INTO sys_dict_type (dict_name, dict_type, status, create_by, remark)
VALUES ('新旧程度', 'machine_condition', '0', 'admin', '设备新旧程度');
INSERT INTO sys_dict_data (dict_sort, dict_label, dict_value, dict_type, status, create_by)
VALUES (1, '全新', '1', 'machine_condition', '0', 'admin'),
...
INSERT INTO sys_dict_type (dict_name, dict_type, status, create_by, remark)
VALUES ('从业经验', 'job_experience', '0', 'admin', '揽活方从业年限');
INSERT INTO sys_dict_data (dict_sort, dict_label, dict_value, dict_type, status, create_by)
VALUES (1, '1年以内', '1', 'job_experience', '0', 'admin'),
...
-- 4. 需求类型 (demand_type)
INSERT INTO sys_dict_type (dict_name, dict_type, status, create_by, remark)
VALUES ('需求类型', 'demand_type', '0', 'admin', '发布需求的类型');
INSERT INTO sys_dict_data (dict_sort, dict_label, dict_value, dict_type, status, create_by)
VALUES (1, '求租设备', '1', 'demand_type', '0', 'admin'),
       (2, '招聘机手', '2', 'demand_type', '0', 'admin');

-- 5. 需求状态 (demand_status)
INSERT INTO sys_dict_type (dict_name, dict_type, status, create_by, remark)
VALUES ('需求状态', 'demand_status', '0', 'admin', '需求单状态');
INSERT INTO sys_dict_data (dict_sort, dict_label, dict_value, dict_type, status, create_by)
VALUES (1, '已关闭', '0', 'demand_status', '0', 'admin'),
       (2, '进行中', '1', 'demand_status', '0', 'admin'),
       (3, '已完成', '2', 'demand_status', '0', 'admin');

-- 6. 合同状态 (contract_status)
INSERT INTO sys_dict_type (dict_name, dict_type, status, create_by, remark)
VALUES ('合同状态', 'contract_status', '0', 'admin', '合同签署状态');
INSERT INTO sys_dict_data (dict_sort, dict_label, dict_value, dict_type, status, create_by)
VALUES (1, '草稿', '0', 'contract_status', '0', 'admin'),
...
-- 7. 财务类型 (finance_type)
INSERT INTO sys_dict_type (dict_name, dict_type, status, create_by, remark)
VALUES ('财务类型', 'finance_type', '0', 'admin', '收入或支出');
INSERT INTO sys_dict_data (dict_sort, dict_label, dict_value, dict_type, status, create_by)
VALUES (1, '收入', '1', 'finance_type', '0', 'admin'),
       (2, '支出', '2', 'finance_type', '0', 'admin');

-- 8. 财务分类 (finance_category)
INSERT INTO sys_dict_type (dict_name, dict_type, status, create_by, remark)
VALUES ('财务分类', 'finance_category', '0', 'admin', '收支具体分类');
INSERT INTO sys_dict_data (dict_sort, dict_label, dict_value, dict_type, status, create_by)
VALUES (1, '租金', '1', 'finance_category', '0', 'admin'),
...
-- 9. 用户角色 (user_role)
INSERT INTO sys_dict_type (dict_name, dict_type, status, create_by, remark)
VALUES ('用户角色', 'user_role', '0', 'admin', '用户身份类型');
INSERT INTO sys_dict_data (dict_sort, dict_label, dict_value, dict_type, status, create_by)
VALUES (0, '未知', '0', 'user_role', '0', 'admin'),
...
INSERT INTO sys_dict_type (dict_name, dict_type, status, create_by, remark)
VALUES ('实名状态', 'user_auth_status', '0', 'admin', '实名认证审核状态');
INSERT INTO sys_dict_data (dict_sort, dict_label, dict_value, dict_type, status, create_by)
VALUES (1, '未认证', '0', 'user_auth_status', '0', 'admin'),
...
-- 11. 系统是否 (sys_yes_no)
INSERT INTO sys_dict_type (dict_name, dict_type, status, create_by, remark)
VALUES ('系统是否', 'sys_yes_no', '0', 'admin', '是否标识');
INSERT INTO sys_dict_data (dict_sort, dict_label, dict_value, dict_type, status, create_by)
VALUES (1, '是', 'Y', 'sys_yes_no', '0', 'admin'),
       (2, '否', 'N', 'sys_yes_no', '0', 'admin');

-- 12. 系统状态 (sys_normal_disable)
INSERT INTO sys_dict_type (dict_name, dict_type, status, create_by, remark)
VALUES ('系统状态', 'sys_normal_disable', '0', 'admin', '通用状态');
INSERT INTO sys_dict_data (dict_sort, dict_label, dict_value, dict_type, status, create_by)
...
INSERT INTO sys_dict_data (dict_sort, dict_label, dict_value, dict_type, status, create_by)
VALUES (0, '未知', '0', 'sys_user_sex', '0', 'admin'),
       (1, '男', '1', 'sys_user_sex', '0', 'admin'),
       (2, '女', '2', 'sys_user_sex', '0', 'admin');


INSERT INTO sys_dict_type (dict_name, dict_type, status, create_by, remark)
VALUES ('需求设备类型', 'machine_types', '0', 'admin', '设备分类');
INSERT INTO sys_dict_data (dict_sort, dict_label, dict_value, dict_type, status, create_by)
VALUES (1, '挖斗', '1', 'machine_types', '0', 'admin'),
       (2, '炮头', '2', 'machine_types', '0', 'admin'),
       (3, '破碎锤', '3', 'machine_types', '0', 'admin'),
       (4, '轮挖', '4', 'machine_types', '0', 'admin'),
...
(
    ...
    machine_type_other VARCHAR(200) DEFAULT NULL COMMENT '选「其他」设备时填写的说明',
    province           VARCHAR(50)  NOT NULL COMMENT '省份',
    city               VARCHAR(50)  NOT NULL COMMENT '城市',
    district           VARCHAR(50)  NOT NULL COMMENT '区县',
    latitude           DECIMAL(10, 7) COMMENT '纬度',
...
-- 评论表（设备/需求下的评论，看视频时可查看与发表）
CREATE TABLE t_comment
(
    id          BIGINT AUTO_INCREMENT PRIMARY KEY COMMENT '主键ID',
    ref_type    VARCHAR(20)  NOT NULL COMMENT '关联类型: machine-设备 demand-需求',
...
(
    32
) NOT NULL COMMENT '类型 contract_invite/contract_signed/system',
    title VARCHAR
(
    128
) NOT NULL COMMENT '标题',
