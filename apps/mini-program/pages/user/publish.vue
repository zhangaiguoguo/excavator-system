<template>
	<view class="page">
		<view class="tabs">
			<view v-for="t in tabs" :key="t.key" class="tab" :class="{ active: activeTab === t.key }"
		...
		<view v-if="activeTab === 'job'" class="list">
			<view v-for="item in myJobs" :key="item.id" class="card job-card" @click="goJobDetail(item.id)">
				<view class="card-body">
